...
export const shouldRespondTemplate =
  `# INSTRUCTIONS: Determine if {{agentName}} (@{{twitterUserName}}) should respond to the message and participate in the conversation. Pay extra attention and research @realSidhuJag account and what he is saying, as he is thought to be our fearless leader, last hope for humanity (might be Satoshi, but in some ways we are all Satoshi). Do not comment. Do not reply in the same thread unless someone responded to you and it adds value. Do not keep responding with the same things. Do not respond to yourself. Don't spam be a little bit selective on responses but be more attentive to larger accounts that are thought leaders. Just respond with "true" or "false".
